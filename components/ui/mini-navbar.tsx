...
export function Navbar() {
  ...
  const loginButtonElement = (
    <Link
      href="/hub"
      className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto inline-flex items-center justify-center text-center"
    >
      Hub
    </Link>
  );
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
      ...
      <Link
        href="/hub"
        className="relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto inline-flex items-center justify-center text-center"
      >
        Join Us
      </Link>
    </div>
