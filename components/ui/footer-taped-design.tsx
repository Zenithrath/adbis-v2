...
export function FooterTapedDesign({
  ...
  return (
    <footer
      className={cn(
        "relative w-full text-[#FFFBEB] pt-16 md:pt-24 pb-10 overflow-hidden",
        className
      )}
    >
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-16">
        {/* ── TOP FOOTER ── */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-14 border-b border-white/15">
          <div className="md:col-span-4 space-y-4">
            <Link href="/" className="inline-flex items-center space-x-3">
              <span className="w-4 h-4 bg-[#FF7AAC] rounded-sm rotate-45 inline-block" />
              <span className="text-lg md:text-xl font-black tracking-tight uppercase">
                {brandName}
              </span>
            </Link>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#FF7AAC]">
              Kabinet Sentra Nawasena 2026
            </p>
            <p className="text-xs text-white/40 italic">
              &ldquo;Merangkai sinergi wujudkan aksi&rdquo;
            </p>
            <p className="text-xs text-white/50 leading-relaxed max-w-sm pt-2">
              {tagline}
            </p>
          </div>
          ...
          <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-8 text-xs">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-white/50">
                <li>
                  <Link href="/#prokerja" className="hover:text-white transition-colors">
                    • Invest Adbis
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-white/50">
                <p className="font-semibold text-white/70">Visi:</p>
                <p className="text-[11px] leading-relaxed">
                  Pusat pengembangan kompetensi yang unggul dan berdampak nyata.
                </p>
                <p className="font-semibold text-white/70 pt-1">
                  Misi Ringkas:
                </p>
                <ul className="list-disc list-inside text-[11px] space-y-1 text-white/40">
        ...
        {/* ── CTA BOX ── */}
        <div className="bg-white/10 backdrop-blur-xl border border-white/15 text-[#FFFBEB] rounded-2xl p-8 md:p-12 my-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <span className="text-[10px] font-bold tracking-widest text-[#FF7AAC] uppercase block mb-1">
              SUARAKAN ASPIRASIMU
            </span>
        ...
        {/* ── BOTTOM ── */}
        <div className="flex flex-col sm:flex-row items-center justify-between text-[11px] text-white pt-2">
          <p>
            © {currentYear} HMPS Administrasi Bisnis — Kabinet Sentra
            Nawasena. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <a href="#" className="text-white hover:text-[#FF7AAC] transition-colors">
              Instagram
            </a>
            <a href="#" className="text-white hover:text-[#FF7AAC] transition-colors">
              LinkedIn
